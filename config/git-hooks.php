...
return [
    ...
    */
    'code_analyzers' => [
        ...
        'psalm' => [
            'path' => env('PSALM_PATH', 'vendor/bin/psalm'),
            'config' => env('PSALM_CONFIG', 'psalm.xml'),
            'additional_params' => env('PSALM_ADDITIONAL_PARAMS', ''),
            'file_extensions' => env('PSALM_FILE_EXTENSIONS', '/\.php$/'),
            'run_in_docker' => env('PSALM_RUN_IN_DOCKER', false),
            'docker_container' => env('PSALM_DOCKER_CONTAINER', ''),
        ],
        'deptrac' => [
            'path' => env('DEPTRAC_PATH', 'vendor/bin/deptrac'),
            'config' => env('DEPTRAC_CONFIG', 'deptrac.yaml'),
            'additional_params' => env('DEPTRAC_ADDITIONAL_PARAMS', ''),
            'file_extensions' => env('DEPTRAC_FILE_EXTENSIONS', '/\.php$/'),
            'run_in_docker' => env('DEPTRAC_RUN_IN_DOCKER', false),
            'docker_container' => env('DEPTRAC_DOCKER_CONTAINER', ''),
        ],
        'composer_normalize' => [
            'path' => env('COMPOSER_NORMALIZE_PATH', 'vendor/bin/composer-normalize'),
            'file_extensions' => env('COMPOSER_NORMALIZE_FILE_EXTENSIONS', '/composer\.json$/'),
            'run_in_docker' => env('COMPOSER_NORMALIZE_RUN_IN_DOCKER', false),
            'docker_container' => env('COMPOSER_NORMALIZE_DOCKER_CONTAINER', ''),
        ],
        'pest' => [
            'path' => env('PEST_PATH', 'vendor/bin/pest'),
            'additional_params' => env('PEST_ADDITIONAL_PARAMS', ''),
            'run_in_docker' => env('PEST_RUN_IN_DOCKER', false),
            'docker_container' => env('PEST_DOCKER_CONTAINER', ''),
        ],
        'phpunit' => [
            'path' => env('PHPUNIT_PATH', 'vendor/bin/phpunit'),
            'additional_params' => env('PHPUNIT_ADDITIONAL_PARAMS', ''),
            'run_in_docker' => env('PHPUNIT_RUN_IN_DOCKER', false),
            'docker_container' => env('PHPUNIT_DOCKER_CONTAINER', ''),
        ],
        'vitest' => [
            'path' => env('VITEST_PATH', 'node_modules/.bin/vitest'),
            'additional_params' => env('VITEST_ADDITIONAL_PARAMS', ''),
            'run_in_docker' => env('VITEST_RUN_IN_DOCKER', false),
            'docker_container' => env('VITEST_DOCKER_CONTAINER', ''),
        ],
        'codeception' => [
            'path' => env('CODECEPTION_PATH', 'vendor/bin/codecept'),
            'additional_params' => env('CODECEPTION_ADDITIONAL_PARAMS', ''),
            'run_in_docker' => env('CODECEPTION_RUN_IN_DOCKER', false),
            'docker_container' => env('CODECEPTION_DOCKER_CONTAINER', ''),
        ],
    ],
