...
- **Pre-configured Hooks:** Laravel Git Hooks comes with pre-configured pre-commit hooks for popular tools, such as Laravel Pint, Composer Normalize, Larastan, Psalm, Deptrac, Rector, PHP Insights, Pest, PHPUnit, Codeception, Vitest, ESLint, Prettier, and Blade Formatter, making it easy to enforce coding standards and style guidelines right away.
...
- **Code Quality:** The package is thoroughly tested with >80% code coverage, ensuring its reliability and stability in a wide range of Laravel projects.
...
'pre-commit' => [
    ...
    \Igorsgm\GitHooks\Console\Commands\Hooks\ComposerNormalizePreCommitHook::class,  // Composer Normalize
    \Igorsgm\GitHooks\Console\Commands\Hooks\LarastanPreCommitHook::class,           // Larastan
    \Igorsgm\GitHooks\Console\Commands\Hooks\PsalmPreCommitHook::class,              // Psalm
    \Igorsgm\GitHooks\Console\Commands\Hooks\DeptracPreCommitHook::class,            // Deptrac
    \Igorsgm\GitHooks\Console\Commands\Hooks\RectorPreCommitHook::class,             // Rector
    \Igorsgm\GitHooks\Console\Commands\Hooks\PhpInsightsPreCommitHook::class,         // PHP Insights

    // Test Runners
    \Igorsgm\GitHooks\Console\Commands\Hooks\PestPreCommitHook::class,                // Pest
    \Igorsgm\GitHooks\Console\Commands\Hooks\PHPUnitPreCommitHook::class,             // PHPUnit
    \Igorsgm\GitHooks\Console\Commands\Hooks\CodeceptionPreCommitHook::class,         // Codeception
    \Igorsgm\GitHooks\Console\Commands\Hooks\VitestPreCommitHook::class,              // Vitest
    ...
    \Igorsgm\GitHooks\Console\Commands\Hooks\BladeFormatterPreCommitHook::class,       // Blade Formatter
],
```
